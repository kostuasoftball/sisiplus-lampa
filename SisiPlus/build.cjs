...
const files = ['api.js', 'adapter-utils.js', 'auth.js', 'player.js', 'ui.js', 'settings.js', 'core.js']
...
fs.writeFileSync(path.join(root, 'dist', `sisiplus-${version}.js`), bundle, 'utf8');
...
console.log(`Built dist/sisiplus.js, dist/sisiplus-${version}.js and ../s.js from ${files.length} modules`);
